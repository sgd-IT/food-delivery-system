...
import com.fooddelivery.constant.AutoFillConstant;
...
public class AutoFillAspect {
    ...
    /**
     * 定义切入点表达式，匹�?mapper 包下所有带�?@AutoFill 注解的方�?
     */
    @Pointcut("execution(* com.fooddelivery.mapper.*.*(..)) && @annotation(com.fooddelivery.annotation.AutoFill)")
     ...
     *
     * @param joinPoint 连接点对象，用于获取方法签名和参数信�?
     * @throws NoSuchMethodException     当反射获取方法失败时抛出
     * @throws InvocationTargetException 当反射调用方法过程中发生异常时抛�?
    ...
    public void autoFill(JoinPoint joinPoint) throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        ...
        OperationType operationType = autoFill.value(); // 获取数据库操作类�?
