...
import com.fooddelivery.config.RedisConfiguration;
...
import com.fooddelivery.mapper.DishFlavorMapper;
...
public class DishServiceImpl implements DishService {
    ...
    public DishVO getDishByIdWithFlavor(Long id) {
        ...
        BeanUtils.copyProperties(dish, dishVO);//将dish中的属性值拷贝到dishVO中，包括菜品的id和名�?
